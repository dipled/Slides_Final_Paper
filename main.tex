...
\section[]{Introdução}
    ...
    \begin{frame}{Introdução}
        \begin{itemize}
            ...
            \item As provas desenvolvidas no assistente possuem um grau de confiabilidade dificilmente encontrado em provas manuais pois independe de um avaliador para garantir sua correção.
        \end{itemize}
    \end{frame}
